...
class Word2007 extends AbstractWriter implements WriterInterface
{
    ...
    public function save($filename = null)
    {
        ...
        foreach ($this->parts as $partName => $fileName) {
        	//echo $partName.'</br>';
            if ($fileName != '') {
            	//echo $this->getWriterPart($partName)->write();
            	if($partName=='Document'){
            		//echo $this->getWriterPart($partName)->write();exit;
            		$content = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<w:document xmlns:ve="http://schemas.openxmlformats.org/markup-compatibility/2006" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:m="http://schemas.openxmlformats.org/officeDocument/2006/math" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:wp="http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main" xmlns:wne="http://schemas.microsoft.com/office/word/2006/wordml"><w:body><w:p><w:pPr/><w:r><w:pict><v:shape type="#_x0000_t0202" style="width:80.71428571429px; height:617.85714285714px;  position:relative; mso-position-horizontal:left; mso-position-vertical: center; mso-position-horizontal-relative:page; mso-position-vertical-relative:margin;mso-fit-text-to-shape:true;layout-flow:horizontal;direction:context;mso-direction-alt:ltr" direction="ltr"><w10:wrap type="inline" anchorx="page" anchory="page"/><v:stroke/><v:textbox style="rotate:-90;" rotate="90"><w:txbxContent ><w:p><w:pPr/><w:r><w:rPr><w:color w:val="AACC00"/><w:b/><w:i/><w:iCs/></w:rPr><w:t xml:space="preserve">你好</w:t></w:r></w:p></w:txbxContent></v:textbox></v:shape></w:pict></w:r></w:p><w:p><w:pPr/><w:r><w:rPr/><w:t xml:space="preserve">My name is Lily</w:t></w:r></w:p><w:p><w:pPr/><w:r><w:rPr/><w:t xml:space="preserve">He is a boy</w:t></w:r></w:p><w:sectPr><w:footerReference w:type="default" r:id="rId7"/><w:pgSz w:orient="portrait" w:w="11870" w:h="16787"/><w:pgMar w:top="1440" w:right="1440" w:bottom="1440" w:left="1440" w:header="720" w:footer="720" w:gutter="0"/><w:cols w:num="1" w:space="720"/></w:sectPr></w:body></w:document>';
